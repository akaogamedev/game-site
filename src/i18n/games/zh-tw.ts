...
export const zhTwGames: Record<string, GameTranslation> = {
  ...
  numphabet: {
    title: "Numphabet",
    catch: "用數字解開英文單字的 60 秒文字解謎。",
    genre: "文字解謎",
    dialogue: [
      { speaker: "onaga", text: "Numphabet……這個要怎麼唸啊？" },
      { speaker: "akao", text: "唸作「Num-phabet」，是 number 和 alphabet 組合起來的。A=1、B=2，一直到 Z=26。出現一個英文單字，你就用數字卡片把它拼出來。" },
      { speaker: "onaga", text: "那 CAT 不就是點 3、1、20 嗎？太簡單了吧。" },
      { speaker: "akao", text: "盤面上一定混著干擾卡，大多只和正確答案差 1～2。從普通難度開始，還會出現先計算的「9+5」卡，以及把 1 變成 Z 的倒數卡。" },
      { speaker: "onaga", text: "倒著數？頭都要暈了……能和朋友一起玩嗎？" },
      { speaker: "akao", text: "用好友代碼加好友，就能解同一個單字來對戰，先贏 5 回合的人獲勝。每天還有 5 題每日挑戰，可以一點一點持續下去。" },
    ],
    features: [
      "A=1……Z=26。由左到右點擊能變成單字字母的數字卡片",
      "60 秒得分挑戰，連續答對 20 次時連擊倍率升到 ×2.00",
      "簡單、普通、困難三種難度：普通加入「9+5」計算卡和把 1 變成 Z 的倒數卡，困難加入先計算再倒數的組合卡",
      "每個盤面至少有 4 張干擾卡，大多與正確答案只差 1～2",
      "每日挑戰：依你已解鎖的難度每天出 5 題，附獎牌和連續紀錄",
      "用好友代碼加好友，在私人房間進行先贏 5 回合的好友對戰（不消耗體力）",
      "各難度的最佳紀錄與排行榜、詳細紀錄，以及可分享的結果圖片",
    ],
    notes: [
      "除了免費主題 Gumdrop，還有外觀、標誌、音樂和音效都會改變的買斷主題 Prism Glass 與 Candy Sky。免費下載，含 App 內購買，無訂閱。支援 iPhone 和 iPad，支援日文和英文。",
    ],
  },
  "time-reversi": {
    title: "時間黑白棋",
  ...
  "bachitto-pose": {
    "title": "Bachitto Pose!（啪地擺好姿勢！）",
    "catch": "對準姿勢穿過牆洞，選錯就落水！",
    "genre": "動作",
    "dialogue": [
      {
        "speaker": "onaga",
        "text": "這個洞真的穿得過去嗎？牆越近，我越緊張！"
      },
      {
        "speaker": "akao",
        "text": "姿勢剛好吻合、順利穿過去的瞬間特別痛快。下一面牆又會換一組姿勢，可不能鬆懈。"
      },
      {
        "speaker": "onaga",
        "text": "成功了真想得意一下！可是選錯就要下水了……"
      },
      {
        "speaker": "akao",
        "text": "掌聲和水花就像綜藝節目的現場。總想再試一次，多過一面牆。"
      }
    ],
    "features": [
      "觀察迎面而來的牆洞，從四個姿勢中選出相同的形狀",
      "每面牆都會更換候選姿勢；連續通過後，牆會逐漸加速",
      "成功時閃出「バチッ！」，失敗時向後飛出並濺起水花",
      "鼓聲與掌聲炒熱氣氛，線上排行榜比拚連續通過的牆數"
    ],
    "controls": [
      {
        "label": "選擇姿勢",
    ...
    "notes": [
      "在牆抵達前擺出與洞口相同的姿勢，挑戰連續通過紀錄。",
      "建議使用電腦瀏覽器。遊戲內文字為日文。"
    ]
  },
  "tsukkomi-dojo": {
    "title": "吐槽道場",
    "catch": "搭檔拋出梗，你來抓準節奏吐槽！目標是「天下第一吐槽」。",
    "genre": "搞笑",
    "dialogue": [
      {
        "speaker": "onaga",
      ...
      {
        "speaker": "akao",
        "text": "這是一款用自己的聲音吐槽搭檔「真勝」的漫才遊戲。真勝扮演便利商店店員，接待方式總是有點怪怪的。"
      },
      {
        "speaker": "onaga",
        "text": "吐槽可是我的拿手好戲！"
      ...
      {
        "speaker": "akao",
        "text": "全場氣氛能有多熱烈，是由AI判定你的吐槽來決定的。"
      },
      {
        "speaker": "onaga",
        "text": "評審是AI啊！要是我來吐槽，全場一定笑翻天！"
      }
    ],
    "features": [
      "用自己的聲音吐槽搭檔「真勝」的漫才遊戲",
      "AI判定吐槽的精準度；準確點出荒謬之處，再加上比喻或巧思評價更高",
      "吐槽漂亮全場爆笑，失手則一片寂靜……在傳統曲藝場舞台上演的短劇漫才",
      "7個梗全部結束後由評審綜合評價，目標是稱號「天下第一吐槽」"
    ],
    "controls": [
      {
        "label": "語音遊玩",
        "text": "梗說完後對著麥克風吐槽。請在unityroom頁面點擊「別タブで開く」（在新分頁開啟）並允許使用麥克風"
      },
      {
        "label": "文字遊玩",
        "text": "在梗後出現的輸入框中輸入吐槽並按Enter，以開始輸入的時刻計算時機"
      },
      {
        "label": "重新遊玩",
        "text": "結果畫面的「もう一度」或「タイトルへ」"
      }
    ],
    "notes": [
      "每局約3分鐘。不方便出聲也可以用文字吐槽。",
      "吐槽的判定使用了AI，吐槽的文字（語音時為辨識出的文字）會傳送到判定伺服器。",
      "建議使用電腦版Chrome。遊戲內文字為日文，語音辨識僅支援日語。"
    ]
  },
};
