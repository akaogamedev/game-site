...
export const koGames: Record<string, GameTranslation> = {
  ...
  "spellbreak-endless-curse": {
    ...
    dialogue: [
      ...
      {
        speaker: "akao",
        text: "마나가 차면 세 장의 카드 중 하나를 골라 강화해. 화염 폭발은 3히트마다 주변을 폭발시키고, 연쇄 번개는 8히트마다 가까운 블록으로 이어져. 얼음 속박은 저주 벽이 전진할 때 위험한 줄을 얼리고, 환영 구슬은 랠리가 이어질수록 늘어나며, 마도 빔은 지팡이에서 빔을 발사해. 각 마법은 Lv5까지 강화할 수 있어.",
      },
    ],
    features: [
