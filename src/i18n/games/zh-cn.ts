...
export const zhCnGames: Record<string, GameTranslation> = {
  ...
  numphabet: {
    title: "Numphabet",
    catch: "用数字解开英文单词的 60 秒文字解谜。",
    genre: "文字解谜",
    dialogue: [
      { speaker: "onaga", text: "Numphabet……这个要怎么念啊？" },
      { speaker: "akao", text: "读作「Num-phabet」，是 number 和 alphabet 拼起来的。A=1、B=2，一直到 Z=26。出现一个英文单词，你就用数字卡片把它拼出来。" },
      { speaker: "onaga", text: "那 CAT 不就是点 3、1、20 吗？太简单了吧。" },
      { speaker: "akao", text: "盘面上一定混着干扰卡，大多只和正确答案差 1～2。从普通难度开始，还会出现先计算的「9+5」卡，以及把 1 变成 Z 的倒数卡。" },
      { speaker: "onaga", text: "倒着数？头都要晕了……能和朋友一起玩吗？" },
      { speaker: "akao", text: "用好友代码加好友，就能解同一个单词来对战，先赢 5 回合的人获胜。每天还有 5 道每日挑战，可以一点点坚持下去。" },
    ],
    features: [
      "A=1……Z=26。从左到右点击能变成单词字母的数字卡片",
      "60 秒得分挑战，连续答对 20 次时连击倍率升到 ×2.00",
      "简单、普通、困难三种难度：普通加入「9+5」计算卡和把 1 变成 Z 的倒数卡，困难加入先计算再倒数的组合卡",
      "每个盘面至少有 4 张干扰卡，大多与正确答案只差 1～2",
      "每日挑战：按你已解锁的难度每天出 5 道题，附奖牌和连续记录",
      "用好友代码加好友，在私人房间进行先赢 5 回合的好友对战（不消耗体力）",
      "各难度的最佳纪录与排行榜、详细记录，以及可分享的结果图片",
    ],
    notes: [
      "除了免费主题 Gumdrop，还有外观、标志、音乐和音效都会改变的买断主题 Prism Glass 与 Candy Sky。免费下载，含应用内购买，无订阅。支持 iPhone 和 iPad，支持日语和英语。",
    ],
  },
  "time-reversi": {
    title: "时间黑白棋",
  ...
  "bachitto-pose": {
    "title": "Bachitto Pose!（啪地摆好姿势！）",
    "catch": "对准姿势穿过墙洞，选错就落水！",
    "genre": "动作",
    "dialogue": [
      {
        "speaker": "onaga",
        "text": "这洞真的能穿过去吗？墙越近，我越紧张！"
      },
      {
        "speaker": "akao",
        "text": "姿势刚好吻合、顺利穿过去的瞬间特别痛快。下一面墙又会换一组姿势，可不能松懈。"
      },
      {
        "speaker": "onaga",
        "text": "成功了真想得意一下！可选错就要下水了……"
      },
      {
        "speaker": "akao",
        "text": "掌声和水花就像综艺节目的现场。总想再试一次，多过一面墙。"
      }
    ],
    "features": [
      "观察迎面而来的墙洞，从四个姿势中选出相同的形状",
      "每面墙都会更换候选姿势；连续通过后，墙会逐渐加速",
      "成功时闪出「バチッ！」，失败时向后飞出并溅起水花",
      "鼓声与掌声烘托气氛，在线排行榜比拼连续通过的墙数"
    ],
    "controls": [
      {
        "label": "选择姿势",
    ...
    "notes": [
      "在墙到达前摆出与洞口相同的姿势，挑战连续通过纪录。",
      "推荐使用电脑浏览器。游戏内文字为日语。"
    ]
  },
  "tsukkomi-dojo": {
    "title": "吐槽道场",
    "catch": "搭档抛出梗，你来掐准节奏吐槽！目标是“天下第一吐槽”。",
    "genre": "搞笑",
    "dialogue": [
      {
        "speaker": "onaga",
      ...
      {
        "speaker": "akao",
        "text": "这是一款用自己的声音吐槽搭档“真胜”的漫才游戏。真胜扮演便利店店员，接待方式总是有点不对劲。"
      },
      {
        "speaker": "onaga",
        "text": "吐槽可是我的拿手好戏！"
      ...
      {
        "speaker": "akao",
        "text": "全场气氛能有多热烈，是由AI判定你的吐槽来决定的。"
      },
      {
        "speaker": "onaga",
        "text": "评委是AI啊！要是我来吐槽，全场肯定笑翻天！"
      }
    ],
    "features": [
      "用自己的声音吐槽搭档“真胜”的漫才游戏",
      "AI判定吐槽的准确度；精准点出荒谬之处，再加上比喻或巧思评价更高",
      "吐槽漂亮全场爆笑，失手则一片寂静……在传统曲艺场舞台上演的短剧漫才",
      "7个梗全部结束后由评委综合评价，目标是称号“天下第一吐槽”"
    ],
    "controls": [
      {
        "label": "语音游玩",
        "text": "梗说完后对着麦克风吐槽。请在unityroom页面点击“別タブで開く”（在新标签页打开）并允许使用麦克风"
      },
      {
        "label": "文字游玩",
        "text": "在梗后出现的输入框中输入吐槽并按Enter，以开始输入的时刻计算时机"
      },
      {
        "label": "重新游玩",
        "text": "结果画面的“もう一度”或“タイトルへ”"
      }
    ],
    "notes": [
      "每局约3分钟。不方便出声也可以用文字吐槽。",
      "吐槽的判定使用了AI，吐槽的文字（语音时为识别出的文字）会发送到判定服务器。",
      "推荐使用电脑版Chrome。游戏内文字为日语，语音识别仅支持日语。"
    ]
  },
};
